...
- FR-015: User can add photos to a recently happened event. Priority: nice-to-have
  > Socrates: Counter-argument considered: videos are a different expensive product. Resolution: videos deprioritized. Photos after the event stay nice-to-have.
